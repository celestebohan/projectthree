...
canvas.position(0,0);
welcome.style.backgroundColor = colors[Math.floor(Math.random() * colors.length)]
...
// //if the ellipse fill is equal to the paintContainer color, then make body the paintContainer color
// if (ellipse() ===  (paintContainer.style.backgroundColor = paint.fields.hex)){
//   body.style.backgroundColor = paint.fields.hex;
// }
